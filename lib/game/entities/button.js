    ...
    update: function() {
        ...
        if( this.currentAnim ) {
            ...
            if(this.sprite) {
                ...
                if(this.anchor.x === 0.5) this.sprite.position.x = this.pos.x + (this.size.x) - (this.offset.x/2);
                else this.sprite.position.x = this.pos.x - this.offset.x;

                if(this.anchor.y === 0.5) this.pos.y + (this.size.y/2) - (this.offset.y/2); 
                else this.sprite.position.y = this.pos.y - this.offset.y;
