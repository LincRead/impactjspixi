	...
	update: function() {
		...
		if( this.currentAnim ) {
			...
			if(this.sprite) {
				...
				var targetX = this.sprite.position.x - (this.size.x * this.anchor.x);// - ig.game._rscreen.x;
				var targetY = this.sprite.position.y - (this.size.y * this.anchor.y);// - ig.game._rscreen.y;
